# Tests for Pulse::ResponsesClient. Verifies prompt sending, response
...
class TestResponsesClient < Minitest::Test
	...
	def test_sends_prompt_and_returns_text
		...
		client = Pulse::ResponsesClient.new(
	...
	def test_raises_on_api_error
		...
		error = assert_raises( Pulse::ResponsesClient::APIError ) do
			client.chat( "test", connection: conn )
		end
